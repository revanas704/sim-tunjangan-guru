...
-- VERSION: 3.0 - COMPLETE RESET (Cleans all old triggers first)
-- ==========================================

-- CATATAN PENTING:
-- 1. Script ini akan menghapus SEMUA trigger dan fungsi lama
-- 2. Kemudian membuat ulang tabel, trigger, dan fungsi
-- 3. Pastikan tidak ada data penting sebelum menjalankan script ini

-- ==========================================
-- STEP 0: Clean up old triggers and functions
-- ==========================================

-- 0.1 Hapus semua trigger terlebih dahulu
...
-- 4.1 Insert Admin User (Password: admin123)
...
-- 4.2 Insert Guru User (Password: guru123)
INSERT INTO "User" (username, password, role)
VALUES (
    'guru',
    '$2a$10$rO9k6LdJXqVQVqVWJvTLeTfJ6HjZV4WqKZfK7Y7Y6Hq3M8X5C0u',
...
-- 4.5 Insert Sample DAK Detail Penerima
...
-- 5.0 Buat fungsi update timestamp
